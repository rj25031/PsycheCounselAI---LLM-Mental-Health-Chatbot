...
export default function ChatApp() {
  ...
  const handleNewChat = () => {
    ...
    const newChat = { timestamp: new Date().toLocaleString() };
    ...
    <div className="flex h-screen relative overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2 mt-4">
          <NavLink to="/">
            <img src="/src/assets/B Logo.svg" alt="Logo" className="w-120 md:w-80" />
          </NavLink>
        </div>
          ...
          <div className="flex-1 flex justify-center md:justify-start">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-green-600 text-center">Online</p>
              </div>
            </div>
          </div>
        ...
        <div className="fixed inset-0 backdrop-blur-sm  flex items-center justify-center z-50">
          <div className="bg-purple-100 p-8 rounded-2xl shadow-xl w-150 h-75 relative">
            ...
            <div className="flex space-x-4 mb-4">
              {["General", "Personalized", "Speech"].map((tab) => (
                <button
                  key={tab}
                  className={`px-3 py-1 rounded-full ${
                    activeTab === tab ? "bg-purple-400 text-white" : "bg-white text-purple-500"
                  }`}
